...
public final class AInCaseThatInCaseThat extends PInCaseThat
{
    private TIn _in_;
    ...
    public Object clone()
    {
        return new AInCaseThatInCaseThat(
            cloneNode(this._in_),
    ...
    {
        ((Analysis) sw).caseAInCaseThatInCaseThat(this);
    }
