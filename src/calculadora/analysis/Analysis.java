...
public interface Analysis extends Switch
{
    ...
    void caseAMaiorigualExpComp(AMaiorigualExpComp node);
    void caseAMenorigualExpComp(AMenorigualExpComp node);
    void caseADiferenteExpComp(ADiferenteExpComp node);
