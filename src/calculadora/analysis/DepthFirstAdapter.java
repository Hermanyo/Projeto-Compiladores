...
public class DepthFirstAdapter extends AnalysisAdapter
{
    ...
    public void inAUnaltInicializedDeclaracao(AUnaltInicializedDeclaracao node)
    {
        defaultIn(node);
    }
    ...
    @Override
    public void caseAUnaltInicializedDeclaracao(AUnaltInicializedDeclaracao node)
    {
        inAUnaltInicializedDeclaracao(node);
        if(node.getTipo() != null)
        {
            node.getTipo().apply(this);
        }
        ...
        outAUnaltInicializedDeclaracao(node);
    }
    ...
    public void caseAVarIdposVar(AVarIdposVar node)
    {
        ...
        {
            List<PExp> copy = new ArrayList<PExp>(node.getAddPos());
            for(PExp e : copy)
            {
                e.apply(this);
            }
