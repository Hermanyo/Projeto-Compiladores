...
public final class AIfElseNoShortOtherwise extends POtherwise
{
    private TIn _in_;
    ...
    public AIfElseNoShortOtherwise()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AIfElseNoShortOtherwise(
            cloneNode(this._in_),
    ...
    {
        ((Analysis) sw).caseAIfElseNoShortOtherwise(this);
    }
