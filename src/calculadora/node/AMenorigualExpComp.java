...
public final class AMenorigualExpComp extends PExpComp
{
    private PExp _exp_;
    private TLoe _loe_;
    private PFator _fator_;

    public AMenorigualExpComp()
    {
        // Constructor
    }
    ...
    public AMenorigualExpComp(
        ...
        @SuppressWarnings("hiding") TLoe _loe_,
    ...
    public Object clone()
    {
        return new AMenorigualExpComp(
            cloneNode(this._exp_),
            cloneNode(this._loe_),
    ...
    {
        ((Analysis) sw).caseAMenorigualExpComp(this);
    }
    ...
    public void setLoe(TLoe node)
    {
        if(this._loe_ != null)
        {
            this._loe_.parent(null);
        }
    ...
    void replaceChild(@SuppressWarnings("unused") Node oldChild, @SuppressWarnings("unused") Node newChild)
    {
        ...
        if(this._loe_ == oldChild)
        {
            setLoe((TLoe) newChild);
            return;
        }
